...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0Ijo1OTEyLCJ1c2VyIjo2OTI3fQ:1pMB8F:BCSSwJ_SSsA362BUiu0Q0SIEWSIpBqAHsTOrEOj3b0g'
        try:
            test_data = [
                ('Drevo().vsota()', 0),
                ('Drevo(5, levo=Drevo(3, levo=Drevo(1)), desno=Drevo(2, levo=Drevo(6), desno=Drevo(9))).vsota()', 26),
                ('Drevo(3).vsota()', 3),
                ('Drevo(5, levo=Drevo(4, desno=Drevo(2)), desno=Drevo(3, levo=Drevo(4), desno=Drevo(4))).vsota()', 22),
                ('Drevo(5, levo=Drevo(4, desno=Drevo(2)), desno=Drevo(3, levo=Drevo(5, levo=Drevo(3, levo=Drevo(1)), desno=Drevo(2, levo=Drevo(6), desno=Drevo(9))), desno=Drevo(3, levo=Drevo(4), desno=Drevo(4)))).vsota()', 51),
            ]
            for td in test_data:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0Ijo1OTEzLCJ1c2VyIjo2OTI3fQ:1pMB8F:tVsvyaPPfR1MNJeXjsOjWXtdzv59Dd4WSScxFCuTelA'
        try:
            test_data = [
                ('Drevo(5, levo=Drevo(3, levo=Drevo(1)), desno=Drevo(2, levo=Drevo(6), desno=Drevo(9))).stevilo_listov()', 3),    
                ('Drevo().stevilo_listov()', 0),
                ('Drevo(3).stevilo_listov()', 1),
                ('Drevo(5, levo=Drevo(4, desno=Drevo(2)), desno=Drevo(3, levo=Drevo(4), desno=Drevo(4))).stevilo_listov()', 3),
                ('Drevo(5, levo=Drevo(4, desno=Drevo(2)), desno=Drevo(3, levo=Drevo(5, levo=Drevo(3, levo=Drevo(1)), desno=Drevo(2, levo=Drevo(6), desno=Drevo(9))), desno=Drevo(3, levo=Drevo(4), desno=Drevo(4)))).stevilo_listov()', 6),
            ]
            for td in test_data:
                if not Check.equal(*td):
                    break
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0Ijo1OTE0LCJ1c2VyIjo2OTI3fQ:1pMB8F:DGY711UsvesOeyfpAog7M-ubAsz5K-m3Fxk8kplox7A'
        try:
            test_data = [
                ('Drevo(5, levo=Drevo(3, levo=Drevo(1)), desno=Drevo(2, levo=Drevo(6), desno=Drevo(9))).minimum()', 1),
                ('Drevo().minimum()', None),
                ('Drevo(3).minimum()', 3),
                ('Drevo(5, levo=Drevo(4, desno=Drevo(2)), desno=Drevo(3, levo=Drevo(4), desno=Drevo(4))).minimum()', 2),
                ('Drevo(5, levo=Drevo(4, desno=Drevo(21)), desno=Drevo(23, levo=Drevo(5, levo=Drevo(13, levo=Drevo(11)), desno=Drevo(24, levo=Drevo(6), desno=Drevo(9))), desno=Drevo(13, levo=Drevo(4), desno=Drevo(4)))).minimum()', 4),
            ]
            for td in test_data:
                if not Check.equal(*td):
                    break
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0Ijo1OTE1LCJ1c2VyIjo2OTI3fQ:1pMB8F:3npIzsqq6XcFuqI3BeR_GJxw83IMfY_irLf0sAwu4gA'
        try:
            test_data = [
                ('list(Drevo(5, levo=Drevo(3, levo=Drevo(1)), desno=Drevo(2, levo=Drevo(6), desno=Drevo(9))).premi_pregled())', [5, 3, 1, 2, 6, 9]),
                ('list(Drevo().premi_pregled())', []),
                ('list(Drevo(3).premi_pregled())', [3]),
                ('list(Drevo(5, levo=Drevo(4, desno=Drevo(2)), desno=Drevo(3)).premi_pregled())', [5, 4, 2, 3]),
                ('list(Drevo(5, levo=Drevo(4, desno=Drevo(2)), desno=Drevo(3, levo=Drevo(4), desno=Drevo(4))).premi_pregled())', [5, 4, 2, 3, 4, 4]),
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0Ijo1OTE2LCJ1c2VyIjo2OTI3fQ:1pMB8F:5d8JBrQfbTLCWgvZ3-FkxhHO91WDnPlH1CDsMy9ccpM'
        try:
            test_data = [
                ('list(Drevo(5, levo=Drevo(3, levo=Drevo(1)), desno=Drevo(2, levo=Drevo(6), desno=Drevo(9))).vmesni_pregled())', [1, 3, 5, 6, 2, 9]),
                ('list(Drevo().vmesni_pregled())', []),
                ('list(Drevo(3).vmesni_pregled())', [3]),
                ('list(Drevo(5, levo=Drevo(4, desno=Drevo(2)), desno=Drevo(3)).vmesni_pregled())', [4, 2, 5, 3]),
                ('list(Drevo(5, levo=Drevo(4, desno=Drevo(2)), desno=Drevo(3, levo=Drevo(4), desno=Drevo(4))).vmesni_pregled())', [4, 2, 5, 4, 3, 4]),
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0Ijo1OTE3LCJ1c2VyIjo2OTI3fQ:1pMB8F:ZLbZaAa0AlyCx1eEv2sAw1cqVd2U0mHDxZbQY6hiwUc'
        try:
            test_data = [
                ('list(Drevo(5, levo=Drevo(3, levo=Drevo(1)), desno=Drevo(2, levo=Drevo(6), desno=Drevo(9))).po_nivojih())', [5, 3, 2, 1, 6, 9]),
                ('list(Drevo().po_nivojih())', []),
                ('list(Drevo(3).po_nivojih())', [3]),
                ('list(Drevo(5, levo=Drevo(4, desno=Drevo(2)), desno=Drevo(3)).po_nivojih())', [5, 4, 3, 2]),
                ('list(Drevo(5, levo=Drevo(4, desno=Drevo(2)), desno=Drevo(3, levo=Drevo(4), desno=Drevo(4))).po_nivojih())', [5, 4, 3, 2, 4, 4]),
